				...
				<div className="card__content">
					<div className="card__history list">
						<div className="card__status list__item">
							<div className="card__number text text_size_18_20 text_view_success">
								{card.buildNumber}
							</div>
							<div className="card__message text text_size_15_20 text_view_truncate">
								{card.commitMessage}
							</div>
						</div>
						<div className="list__item meta meta_m-distribute_vertical">
							<div className="meta__item">
								<div className="icon-content">
									<div
										className="icon-content__icon icon-content__icon_size_m
													icon-content__icon_indent-r_4 "
									>
										<div className="icon text text_view_semi-ghost">
											<svg
												width="16"
												height="8"
												viewBox="0 0 16 8"
					...
					<div
						className="card__meta card__meta_m-hr_top meta meta_distribute_vertical 
							meta_m-distribute_horizontal text text_size_13_16 text_view_ghost"
					>
						<div className="meta__item meta__item_indent-b_8 ">
							<div className="icon-content">
								<div
